...
g++ server.cpp rend.cpp std.cpp -I. glad.o stb_image.o http.o -Iimgui/backends -Iimgui imgui_unity.o -ldl -lglfw -lGLU -lGL -lXrandr -lX11 -lrt -O3 -lpthread -std=c++17 -o server